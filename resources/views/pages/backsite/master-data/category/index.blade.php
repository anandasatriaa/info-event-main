                                ...
                                <div class="card">
                                    ...
                                    <div class="card-content collapse hide">
                                        <div class="card-body card-dashboard">
                                            ...
                                            <form class="form form-horizontal" action="{{ route('backsite.category.store') }}" method="POST" enctype="multipart/form-data">
                                                    ...
                                                    <tbody>
                                                        @forelse($category as $key => $category_item)
                                                            <tr data-entry-id="{{ $category_item->id }}">
                                                                <td>{{ isset($category_item->created_at) ? date("d/m/Y H:i:s",strtotime($category_item->created_at)) : '' }}</td>
                                                                ...
                                                                <td class="text-center">
                                                                    ...
                                                                    <div class="btn-group mr-1 mb-1">
                                                                        ...
                                                                        <div class="dropdown-menu">
                                                                            ...
                                                                            {{-- @can('category_edit') --}}
                                                                                <a class="dropdown-item" href="{{ route('backsite.category.edit', $category_item->id) }}">
                                                                                    Edit
                                                                                </a>
                                                                            {{-- @endcan --}}

                                                                            {{-- @can('category_delete') --}}
                                                                                <form action="{{ route('backsite.category.destroy', $category_item->id) }}" method="POST" onsubmit="return confirm('Are you sure want to delete this data ?');">
