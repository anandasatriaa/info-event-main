                            ...
                            <div class="card">
                                ...
                                <div class="card-content collapse hide">
                                    <div class="card-body card-dashboard">
                                        ...
                                        <form class="form form-horizontal" action="{{ route('backsite.event.store') }}"
                                            ...
                                            <div class="form-body">
                                                ...
                                                <div class="form-group row">
                                                    <label class="col-md-3 label-control" for="name">Name Event<code
                                                            style="color:red;">required</code></label>
                                                    <div class="col-md-9 mx-auto">
                                                        <input type="text" id="name" name="name"
                                                            class="form-control" placeholder="example webinar fullstack"
                                                ...
                                                <div class="form-group row">
                                                    <label class="col-md-3 label-control" for="instance">Instance Event<code
                                                            style="color:red;">required</code></label>
                                                    <div class="col-md-9 mx-auto">
                                                        <input type="text" id="instance" name="instance"
                                                            class="form-control" placeholder="example Gojek, BFD, BWA"
                                                            value="{{ old('instance') }}" autocomplete="off" required>
                                                ...
                                                <div class="form-group row">
                                                    <label class="col-md-3 label-control" for="date">Date Event<code
                                                            style="color:red;">required</code></label>
                                                    <div class="col-md-9 mx-auto">
                                                        <input type="text" id="date" name="date"
                                                            class="form-control" placeholder="2022-01-20"
                                                        ...
                                                        <td class="text-center">
                                                            ...
                                                            <div class="btn-group mr-1 mb-1">
                                                                ...
                                                                <div class="dropdown-menu">
                                                                    ...
                                                                    {{-- @can('event_show') --}}
                                                                    <a href="#mymodal"
                                                                        data-remote="{{ route('backsite.event.show', $event_item->id) }}"
                                                                        data-toggle="modal" data-target="#mymodal"
                                                                        data-title="event Detail" class="dropdown-item">
                                                                        Show
                                                                    </a>
                                                                    {{-- @endcan --}}
                                                                    ...
                                                                    <a class="dropdown-item"
                                                                        href="{{ route('backsite.event.edit', $event_item->id) }}">
                                                                        Edit
                                                                    </a>
                                                                    {{-- @endcan --}}
                                                                    ...
                                                                    {{-- @can('event_delete') --}}
                                                                    <form
                                                                        action="{{ route('backsite.event.destroy', $event_item->id) }}"
                                                                        method="POST"
